...
Theme::Theme(NVGcontext *ctx) {
  ...
  m_font_sans_regular = nvgCreateFontMem (ctx, "sans", (uint8_t *) roboto_regular_ttf, roboto_regular_ttf_size, 0);
  m_font_sans_bold = nvgCreateFontMem (ctx, "sans-bold", (uint8_t *) roboto_bold_ttf, roboto_bold_ttf_size, 0);
  m_font_icons = nvgCreateFontMem (ctx, "icons", (uint8_t *) fontawesome_solid_ttf, fontawesome_solid_ttf_size, 0);
  m_font_mono_regular = nvgCreateFontMem (ctx, "mono", (uint8_t *) inconsolata_regular_ttf, inconsolata_regular_ttf_size, 0);

  if (m_font_sans_regular == -1 || m_font_sans_bold == -1 || m_font_icons == -1 || m_font_mono_regular == -1)
